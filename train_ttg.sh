...
python scripts/rsl_rl/train.py --task=Tracking-Flat-G1-v0 \
--registry_name ianc-uc-berkeley-org/wandb-registry-motions/smpl_extreme_filtered_0 \
--headless --logger wandb --log_project_name ttg --run_name smpl_extreme_filtered_0